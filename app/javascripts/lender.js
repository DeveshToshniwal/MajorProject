      ...
      for(var i = 0; i < proposalLength; i++) {
        contractInstance.getProposalAtPosFor.call(account, i).then(function(el) {
          ...
          $("#proposal-rows").append("<tr id='proposal"+i+"'>\
            ...
            <td>"+el[9].valueOf()+"</td>\
            <td><a target='_blank' href='http://localhost:8080/verify.html?hash="+web3.toUtf8(el[7].valueOf())+web3.toUtf8(el[8].valueOf())+"'>View</a></td>\
      ...
      for(var i = 0; i < 10 && numLoans-1-i >= 0; i++) {
        contractInstance.loanList(numLoans-1-i).then(function(el) {
          ...
          $("#recent-loan-rows").append("<tr class='"+LOANSTATECLASS[el[1].valueOf()]+"'>\
            ...
            <td>"+el[7].valueOf()+"</td>\
            <td><a target='_blank' href='http://localhost:8080/verify.html?hash="+web3.toUtf8(el[8].valueOf())+web3.toUtf8(el[9].valueOf())+"'>View</a></td>\
            <td>" + amountHTML  + "</td>\
            <td>" + rateHTML  + "</td>\
            <td>" + btnHTML  + "</td>\
            <tr>");
